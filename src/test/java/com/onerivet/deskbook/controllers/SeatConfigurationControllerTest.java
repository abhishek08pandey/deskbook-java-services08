...
class SeatConfigurationControllerTest {
    ...
    void testGetSeats_WithColumnId_ReturnsSeatNumberDtoList() {
        ...
        seatNumberDto = Arrays.asList( new SeatNumberDto(2, 1, true),
                new SeatNumberDto(3, 2, true), new SeatNumberDto(4, 3, true), new SeatNumberDto(5, 4, true),
                new SeatNumberDto(6, 5, true), new SeatNumberDto(7, 6, true), new SeatNumberDto(8, 7, true),
                new SeatNumberDto(9, 8, true), new SeatNumberDto(10, 9, true), new SeatNumberDto(11, 10, true));
